				...
				<table class="table table-bordered">
					<tbody>
						...
						<tr>
							...
							<td width="50%"><input class="form-control" type="date" name="start_date" v-model="report.start_date"  /></td>
						</tr>
						<tr>
							<th>End Date : </th>
							<td class="text-center"><input class="form-control" type="date" name="end_date" v-model="report.end_date"  /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input class="form-control" type="text" name="name_hospital" v-model="report.name_hospital" /></td>
						</tr>
						<tr>
							<th>Total number of hospital beds</th>
							<td><input class="form-control" type="text" name="total_beds" v-model="report.total_beds" /></td>
						</tr>
						<tr>
							<th>Total number of ICU beds</th>
							<td><input class="form-control" type="text" name="total_icu_beds" v-model="report.total_icu_beds" /></td>
						</tr>
						<tr>
							<th>Total number of non-ICU beds</th>
							<td><input class="form-control" type="text" name="total_non_icu_beds" v-model="report.total_non_icu_beds" /></td>
						</tr>
						<tr>
							<th>Average number of Doctors on hospital rolls at any point of time</th>
							<td><input class="form-control" type="text" name="avg_doctors" v-model="report.avg_doctors" /></td>
						</tr>
						<tr>
							<th>Average number of Nurses on hospital rolls at any point of time</th>
							<td><input class="form-control" type="text" name="avg_nurses" v-model="report.avg_nurses" /></td>
						</tr>
						<tr>
							<th>Total number of operation theatre tables</th>
							<td><input class="form-control" type="text" name="total_ot" v-model="report.total_ot" /></td>
						</tr>
						<tr>
							<th>Average number of admissions/day</th>
							<td><input class="form-control" type="text" name="avg_admissions_per_day" v-model="report.avg_admissions_per_day" /></td>
						</tr>
						<tr>
							<th>Average number of patients visiting OPD/day</th>
							<td><input class="form-control" type="text" name="avg_patients_visiting_opd" v-model="report.avg_patients_visiting_opd" /></td>
						</tr>
						<tr>
							<th>Average number of patients visiting Emergency/day</th>
							<td><input class="form-control" type="text" name="avg_patients_visiting_emergency" v-model="report.avg_patients_visiting_emergency" /></td>
						</tr>
						<tr>
							<th>Average number of elective surgeries/day</th>
							<td><input class="form-control" type="text" name="avg_surgeries" v-model="report.avg_surgeries" /></td>
						</tr>
						<tr>
							<th>Average number of emergency surgeries/day</th>
							<td><input class="form-control" type="text" name="avg_emergency_surgeries" v-model="report.avg_emergency_surgeries" /></td>
						</tr>
						<tr>
							<th>Average number of day care surgeries/day</th>
							<td><input class="form-control" type="text" name="avg_day_care_surgeries" v-model="report.avg_day_care_surgeries" /></td>
						</tr>
						<tr>
							<th>Average units of water consumed/month</th>
							<td><input class="form-control" type="text" name="avg_units_water" v-model="report.avg_units_water" /></td>
						</tr>
						<tr>
							<th>Average units of electricity consumed/month</th>
							<td><input class="form-control" type="text" name="avg_electricity" v-model="report.avg_electricity" /></td>
						</tr>
					</tbody>
				</table>
			</div>
        ...
        data() {
            return {
                ...
                'report' : {
										...
										'avg_units_water' : '',
										'avg_electricity' : '',
										'total_medication_error' : '',
										'incidence_medication_error' : '',
										'total_inpatient_medicationerror' : '',
										'units_blood_transfusion_reaction' : '',
										'transfusion_reaction' : '',
										'total_units_issued' : '',
										'uninary_catheterised' : '',
										'cauti' : '',
										'uninary_catheter_days' : '',
										'total_episodes_vap' : '',
										'vap_rates' : '',
										'total_ventilator_days' : '',
										'total_crbsi' : '',
										'catheter_related_infection' : '',
										'total_central_line_days' : '',
										'total_ssi' : '',
										'surgical_site_infection' : '',
										'total_surgeries' : '',
										'total_fall_patients' : '',
										'fall_rate' : '',
										'total_inpatient_fall' : '',
										'total_bed_sores' : '',
										'bed_sore' : '',
										'total_inpatient_bedsore' : '',
										'total_patient_days_month' : '',
										'bed_occupancy_rate' : '',
										'available_bed_days' : '',
										'total_inpatient_avgStay' : '',
										'avg_stay' : '',
										'total_spearations' : '',
		    ...
		    testFunction() {
	            ...
	            (response) => {
	            	if (!this.errors.any()) {
				    	...
				    	User.testFunction(this.testData).then(
		                (response) => {
