...
<div class="container">
	...
	<div class="row form-group text-center">
		<button class="btn btn-success" type="submit"  @click = "saveTransferChecklistForNurses()">Submit</button>
	</div>
  </form>
</div>
</div>
    ...
    export default {
        data() {
            return {
                ...
                'transferChecklistForNursesData' : {
										'transfer_to':'',
							      'transfer_from':'',
							      'no01':'',
							      'ch01':'',
        ...
        methods: {
		    ...
		    saveTransferChecklistForNurses() {
		    	this.$validator.validateAll().then(
	            (response) => {
	            	if (!this.errors.any()) {
	            		 $("body .js-loader").removeClass('d-none');
				    	User.saveTransferChecklistForNurses(this.transferChecklistForNursesData).then(
		                (response) => {
